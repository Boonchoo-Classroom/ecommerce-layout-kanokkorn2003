...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recommendedProducts.add(ProductModel("ไวน์แดง", "เปรี้ยว ฝาด หอมอร่อย ไวน์อิตาลี", 1100.00, R.drawable.ic_pen))
        recommendedProducts.add(ProductModel("ไวน์ขาว", "หวาน หอม ไม่ฝาด ไวน์ฝรั่งเศส", 990.00, R.drawable.ic_ruler))
        recommendedProducts.add(ProductModel("สปาร์คกิ้ง", "ซ่า เปรี้ยวหวาน ไม่ฝาด อร่อย", 890.00, R.drawable.ic_notebook))
        ...
        promotionsList.add(ProductModel("ชุดดื่มไวน์", "มีไวน์แดง ไวน์ขาว และแก้วไวน์", 2000.00, R.drawable.bundle_a))
        promotionsList.add(ProductModel("ซื้อ 1 แถม 1", "โปรโมชั่นพิเศษ ซื้อ 1 แถม 1", 1500.00, R.drawable.bundle_a))
